...
team = User.create! email: 'team1@bedlamtheatre.co.uk', name: 'Team 1', password: 'Passw0rd', password_confirmation: 'Passw0rd', role: :team

Setting.create! key: 'scoreboard_end_time', value: '2024-09-28T14:00:00+01:00'
Setting.create! key: 'scoreboard_visible', value: 'false'

Challenge.create! number: 1, description: "Leave a pineapple in front of someone's door", points: 200, group_id: 1

Challenge.create! user: team, group_id: 1
