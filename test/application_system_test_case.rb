...
class ApplicationSystemTestCase < ActionDispatch::SystemTestCase
  ...
  # Headroom over Capybara's 2s default for Turbo navigations on a loaded machine
  # or on CI. Note this alone never fixed the old flakiness -- the failures were
  # dropped clicks, not slow pages, so there was nothing in flight to wait for.
